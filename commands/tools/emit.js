...
exports.run = async (client, message, args, level) => {
    ...
    switch (args[0]) {
        ...
        case 'guildCreate':
            ...
            break;
        default:
            client.sender(message, "Co chcesz emitować?", "", "", "GREEN", [{name: "> \`guildMemberAdd\`", value: "Pozwala na uruchomienie eventu \`guildMemberAdd\`"}, {name: "> \`guildCreate\`", value: "Pozwala na uruchomienie eventu \`guildCreate\`"}])
    }
}
exports.help = {
    name: "emit",

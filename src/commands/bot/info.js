module.exports = {
    ...
    run: async (client, interaction) => {
        client.builder(interaction, `Bot informations`, ``, ``, `GREEN`, [
            ...
            { name: "> History", value: "We started as **Korrumix** in 2018 which was created in DBM but never released to public. In late 2018 we started writing bots in JavaScript, as we progress we want to write more project in js, linked to Krive."},

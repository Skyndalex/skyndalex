...
exports.run = async (client, message, args) => {
    ...
    if (!role) return client.sender(message, "Błąd!", "Nie ustawiono roli!", client.footer, "RED", "", "")
   ...
   await member.roles.remove(role.mutedRole)
    ...
    client.sender(message, "Wyłączono wyciszenie użytkownika!", "", "", "GREEN", [
        {
            name: "Odciszył", value: message.author.tag
        },
        {
            name: "Odciszony użytkownik", value: member.user.tag
        },
        {

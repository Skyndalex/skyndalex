    ...
    switch (interaction.customId) {
        ...
        case "send_complaints":
            ...
            let embedComplaint = new MessageEmbed()
                ...
                .addField(`Description`, `${modalSubmitComplaintInteraction.fields.getTextInputValue("describe_complaint") || "None"}`)
                .addField(`Proofs`, `${modalSubmitComplaintInteraction.fields.getTextInputValue("proofs_complaint") || "None"}`)
        ...
        case "send_suggestions":
            ...
            let embedSuggestion = new MessageEmbed()
                ...
                .setDescription(`You can add more users to ticket with command /ticket add`)
                .addField(`Description`, `${modalSubmitComplaintInteractionSuggestions.fields.getTextInputValue("describe_suggestions") || "None"}`)
                .addField(`Proofs`, `${modalSubmitComplaintInteractionSuggestions.fields.getTextInputValue("files_suggestion") || "None"}`)
                .setColor("GREEN")
        ...
        case "send_mod_questions":
            ...
            let embedQuestion = new MessageEmbed()
                ...
                .setDescription(`You can add more users to ticket with command /ticket add`)
                .addField(`Description`, `${modalSubmitComplaintInteractionQuestions.fields.getTextInputValue("describe_question") || "None"}`)
                .addField(`Proofs`, `${modalSubmitComplaintInteractionQuestions.fields.getTextInputValue("files_questions") || "None"}`)
                .setColor("GREEN")
